...
## สถิติความเร็วที่วัดได้จริง

ตัวเลข throughput จากการรันจริง 24 ครั้งด้วยไฟล์ 50 MiB อยู่ใน
**[`docs/throughput.md`](docs/throughput.md)** เปรียบเทียบระหว่างการรันเดี่ยว
กับการรันพร้อมกันทั้ง 12 ตัว

ตัวเลขที่ได้แกว่งมาก เช่น S3 → SFTP วัดได้ 19.9 MiB/s ตอนรันเดี่ยว แต่เหลือ
1.1 MiB/s ตอนรันพร้อมกัน ต่างกัน 18 เท่าจากโค้ดชุดเดียวกัน จึงควรอ่านเป็นการ
เปรียบเทียบระหว่าง DAG มากกว่าเป็นค่ามาตรฐานของโปรโตคอล
